...
class BusinessPlan extends Model
{
    ...
    protected $casts = [
        ...
        'neugruendung' => 'boolean',
        'backshop' => 'boolean',
        'gastronomie' => 'boolean',
        'verderb_backshop_pct' => 'decimal:2',
        'verderb_gastro_pct' => 'decimal:2',
        'pfandschlupf' => 'boolean',
        'kaffeeautomat' => 'boolean',
        'anzahl_terminal' => 'integer',
        'mautstation' => 'boolean',
        'nebengeschaefte' => 'boolean',
        'unternehmer_pkw' => 'boolean',
        'bruttolistenpreis' => 'decimal:2',
        'digitale_buchhaltung' => 'boolean',
        'mandant_contax' => 'boolean',
        'verfahrensdoku' => 'boolean',
        'werkstatt' => 'boolean',
        'muenzgeraete' => 'boolean',
        'waschanlage' => 'boolean',
        'wasseraufbereitung' => 'boolean',
        'anzahl_waeschen' => 'integer',
        'waschpreis' => 'decimal:2',
        'anzahl_waeschen_1' => 'integer',
        'waschpreis_1' => 'decimal:2',
        'anzahl_waeschen_2' => 'integer',
        'waschpreis_2' => 'decimal:2',
